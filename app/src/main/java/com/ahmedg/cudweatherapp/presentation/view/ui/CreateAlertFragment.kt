...
import com.ahmedg.cudweatherapp.databinding.FragmentCreateAlertBinding
...
class CreateAlertFragment : Fragment(), TimePickerDialog.OnTimeSetListener,
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_create_alert, container, false)
        ...
        binding.startTime.setOnClickListener {
            if (!TextUtils.isEmpty(binding.selectedDate.text)) {
                ...
                Toast.makeText(context, "Please Enter Notification Time", Toast.LENGTH_LONG).show()
    ...
    private fun getRepetition() {
        binding.spinnerReapition.onItemSelectedListener =

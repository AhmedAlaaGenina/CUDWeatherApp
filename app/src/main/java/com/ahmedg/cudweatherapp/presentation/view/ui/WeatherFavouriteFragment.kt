...
import com.ahmedg.cudweatherapp.databinding.FragmentWeatherFavouriteBinding
...
class WeatherFavouriteFragment : Fragment() {
    ...
    private fun fetchWeather() {
        ...
        binding.tvMainDescripationFavourite.text =
            "${args.weatherDate.current.weather[0].main} / ${args.weatherDate.current.weather[0].description}"
